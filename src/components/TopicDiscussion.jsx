...
const TopicDiscussion = ({ onBookmarkTopic, onUnbookmarkTopic, openTopicId = null, compact = false, embedded = false, onRequestClose }) => {
  ...
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      author: '果仁学伴',
      avatar: '🥜',
      time: new Date(Date.now() - 50 * 60 * 1000).toLocaleString('zh-CN', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }),
      title: '学习延展推荐与记忆卡片初始化',
      content: '基于你近期参与“新教师教学方法培训”的学习记录，已为你初始化延展学习包：\n\n【知识点延展】\n- 互动设计原则：推荐阅读《课堂互动的五个层级》，配套案例视频与分析稿\n- 课堂观察维度：教师行为、学生参与、时间分配，提供观察表模板与示例填写\n- 反馈问卷设计：题项库与量表示例，含数据分析入门指南\n\n【记忆卡片】\n- 互动设计关键术语（30张）\n- 课堂管理策略速记（20张）\n\n【自测题】\n- 微课互动设计场景题与判断题（10题），提交后生成解析与建议\n\n点击下方入口可直接打开对应资源与练习。',
      attachments: ['延展资料', '记忆卡片', '自测题', '学习导航'],
      pinned: false,
      liked: false,
      likes: 9,
      bookmarked: true,

  ...
  return (
    <div className="my-assessment">
      ...
      <div className="assessment-content">
        ...
        {/* 详细评估信息 */}
        <Tabs defaultActiveKey="scores" className="assessment-tabs">
          <TabPane tab="量化得分" key="scores">
          ...
          <TabPane tab="薄弱点分析" key="weaknesses">
          ...
          <TabPane tab="改进建议" key="improvements">
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
          ...
          <TabPane tab="历史记录" key="history">
            <Card title="评估历史" className="history-card">
              <Timeline>
                {assessmentData.assessmentHistory.map((record) => (
